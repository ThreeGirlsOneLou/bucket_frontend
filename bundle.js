...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadMap = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#add-button').on('click', function (event) {
	    ...
	    var name = $('#search-result-name').text();
	    var user_id = app.user._id;
	    var long = app.searchlong;
	    var lat = app.searchlat;
	  ...
	  $('#location-list').on('click', '.visited', function (event) {
	    ...
	    var currentLocation = $.grep(app.user.locations, function (e) {
	      return e._id == location_id;
	    });
	    appApi.updateUserLocation(appUi.updateLocationSuccess, appUi.updateLocationFailure, app.user._id, location_id, !currentLocation[0].visited);
	  });
	  ...
	  $('#location-list').on('click', '.remove', function (event) {
	    ...
	    appApi.deleteUserLocation(appUi.deleteLocationSuccess, appUi.deleteLocationFailure, app.user._id, location_id);
	  });
	  ...
	  $('#remove-button').on('click', function (event) {
	    ...
	    for (var i = 0; i < app.user.locations.length; i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getUserLocations = function getUserLocations(success, failure, user_id) {
	  $.ajax({
	    method: 'GET',
	...
	var addUserLocation = function addUserLocation(success, failure, user_id, name, long, lat, url) {
	...
	var deleteUserLocation = function deleteUserLocation(success, failure, user_id, location_id) {
	  $.ajax(_defineProperty({
	    method: 'DELETE',
	...
	var updateUserLocation = function updateUserLocation(success, failure, user_id, location_id, change) {
	  console.log(user_id);
	  $.ajax(_defineProperty({
	    method: 'PATCH',
	    url: app.api + '/locations/' + location_id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(4);
	var loadMap = __webpack_require__(7);
	var loadBucket = __webpack_require__(10);
	var appApi = __webpack_require__(5);

	var getLocationsSuccess = function getLocationsSuccess(data) {
	  console.log('win');
	...
	var addLocationSuccess = function addLocationSuccess(data) {
	  console.log('Success');
	  console.log(data);
	...
	var addLocationFailure = function addLocationFailure(data) {
	  console.log('you fail');
	  console.log(data);
	};

	var getPhotosFailure = function getPhotosFailure(data) {
	  console.log('get photos failed');
	  console.log(data);
	};

	var getPhotosSuccess = function getPhotosSuccess(data) {
	...
	var updateLocationFailure = function updateLocationFailure(data) {
	...
	var deleteLocationSuccess = function deleteLocationSuccess(data) {
	  ...
	  appApi.getUserLocations(getLocationsSuccess, getLocationsFailure, app.user._id);
	  app.addLocation = false;
	};

	var deleteLocationFailure = function deleteLocationFailure(data) {
	  console.log('Delete location Failure');
	  console.log(data);
	};

	var getWikiInfoFailure = function getWikiInfoFailure(data) {
	  console.log(data);
	};

	var getWikiInfoSuccess = function getWikiInfoSuccess(data) {
	  console.log(data);
	  var id = {};
	...
	module.exports = {
	  ...
	  getLocationsFailure: getLocationsFailure,
	  addLocationSuccess: addLocationSuccess,
	  addLocationFailure: addLocationFailure,
	  getPhotosFailure: getPhotosFailure,
	  getPhotosSuccess: getPhotosSuccess,
	  ...
	  getWikiInfoSuccess: getWikiInfoSuccess,
	  getWikiInfoFailure: getWikiInfoFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addSearchBar = function addSearchBar(map) {
	  ...
	  google.maps.event.addListener(autocomplete, 'place_changed', function () {
	    ...
	    var searchAry = $('#search-result-name').text().split(',');
	    wiki.getWikiInfo(ui.getWikiInfoSuccess, ui.getWikiInfoFailure, searchAry[0]);
	  });
	};
	    ...
	    for (i = 0; i < locations.length; i++) {
	      ...
	      google.maps.event.addListener(marker, 'click', function (marker, i) {
	        return function () {
	          ...
	          var searchAry = locations[i].name.split(',');
	          wiki.getWikiInfo(ui.getWikiInfoSuccess, ui.getWikiInfoFailure, searchAry[0]);
	        };
	      }(marker, i));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchTerm = $('#search-result-name').text();

	var getPhotos = function getPhotos(getPhotosSuccess, getPhotosFailure, searchTerm) {
	  $.ajax({
	    method: 'GET',
	  ...
	  }).done(getPhotosSuccess).fail(getPhotosFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getWikiInfo = function getWikiInfo(success, failure, searchTerm) {
	  $.ajax({
	    method: 'GET',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadBucket = function loadBucket() {
	  console.log("Loaded dat bucket");
	  var handlebarsTemplate = __webpack_require__(11);
	  var locations = app.user.locations;
	  console.log(locations);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"col-md-3\">\n      <div class=\"view view-first\">\n        <div class=\"image-container\"><img src="
	    ...
	    + "</h2>\n          <div class=\"icons\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.visited : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + "            <a href=\"#\" class=\"remove info delete\" data-location-id=\""
	    + alias2(alias1((depth0 != null ? depth0._id : depth0), depth0))
	    + "\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Remove from Wanderlist\"><span class=\"glyphicon glyphicon-remove\"></span></a>\n        </div>\n        </div>\n        </div>\n      </div>\n    </div>\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    return "            <a href=\"#\" class=\"visited visited-true\" data-location-id=\""
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0._id : depth0), depth0))
	    + "\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Oops, haven't been here yet!\"><span class=\"glyphicon glyphicon-flag\"></span></a>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "            <a href=\"#\" class=\"visited visited-false\" data-location-id=\""
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0._id : depth0), depth0))
	    + "\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Mark as visited!\"><span class=\"glyphicon glyphicon-flag\"></span></a>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div class=\"row bucket-row\">\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(46);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports) {
	...
	// don't need this function any more, but it will cause issues if I delete it until HTML is edited
